RecipeSite::Application.routes.draw do
  resources :recipes do
    ...
    member do
      get :fork, :random, :newingredient, :forktree, :expand, :minimize
    end
  end
  resources :users do
    member do
      get :following, :followers, :saved_recipes, :show_recipes, :pantry, :newuser, :shopping_list
    end
  end
  ...
  match '/recipes/newingredient',       to: 'recipes#newingredient', via: 'post'
